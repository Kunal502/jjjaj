...
function gotResult(error, results) {
    if (error) {
        ...
        document.getElementById("confdience").innerHTML = "confdience = " + Math.round(results[0].confidence * 100) + "%";
    }
}
...
function updateCanvas() {
    ...
    document.getElementById("sktech_name").innerHTML = "Sktech To Be drawn" + sketch;
}
